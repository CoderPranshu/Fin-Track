      ...
      <div className="glass-card p-4 flex flex-wrap items-center justify-between gap-4">
        <div className="relative flex-1 max-w-md group">
          ...
          <input 
            ...
            className="w-full bg-slate-800/50 border border-white/10 rounded-radius py-2.5 pl-12 pr-4 focus:outline-none focus:border-primary transition-all text-white"
        ...
        <div className="flex items-center gap-4">
          <select 
            className="bg-slate-800/50 border border-white/10 rounded-radius px-4 py-2.5 focus:outline-none focus:border-primary transition-all cursor-pointer"
            value={filters.type} 
              ...
              {loading ? (
                ...
                transactions.map(t => (
                  <tr key={t.id} className="hover:bg-white/5 transition-colors group">
                    <td className="px-6 py-4 text-sm font-medium opacity-70">{format(new Date(t.date), 'MMM dd, yyyy')}</td>
                    <td className="px-6 py-4 text-sm font-semibold">{t.category}</td>
